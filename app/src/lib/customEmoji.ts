...
export const CUSTOM: CustomEmoji[] = [
  ...
  { slug: 'axolotl', name: 'Axolotl', standIn: '🦎', category: 'reptiles' },
  { slug: 'hawk', name: 'Hawk', standIn: '🦅', category: 'birds' },
  { slug: 'lantern-fly', name: 'Lantern Fly', standIn: '🦗', category: 'bugs' },
  { slug: 'emu', name: 'Emu', standIn: '🐦', category: 'birds' },
  { slug: 'wren', name: 'Wren', standIn: '🐦', category: 'birds' },
  { slug: 'crow', name: 'Crow', standIn: '🐦‍⬛', category: 'birds' },
  { slug: 'troll', name: 'Troll', standIn: '🧌', category: 'mammals' },
  { slug: 'dragonfly', name: 'Dragonfly', standIn: '🦋', category: 'bugs' },
  { slug: 'hummingbird', name: 'Hummingbird', standIn: '🐦', category: 'birds' },
  { slug: 'grasshopper', name: 'Grasshopper', standIn: '🦗', category: 'bugs' },
  { slug: 'mockingbird', name: 'Mockingbird', standIn: '🐦', category: 'birds' },
  { slug: 'pony', name: 'Pony', standIn: '🐴', category: 'mammals' },
]
